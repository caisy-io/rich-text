...
export const DEFAULT_BLOCK_MAP: Record<
  ElementType,
  any
> = {
  doc: Doc,
...
export const documentRenderer = (
  blockMap: Record<ElementType, Component<{ node: any }>>
) => {
  const BLOCKS: any = { ...DEFAULT_BLOCK_MAP, ...blockMap };
  ...
  const renderNode = (
    ...
    return (
      <Element
        ...
        path={path}
      >
        {currNode.content?.map((node: any, index: number) =>
